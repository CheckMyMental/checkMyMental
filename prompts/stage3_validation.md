...
## 2. 응답 수집
**중요: 같은 질환에 대한 질문들을 묶어서 한 번에 제시하세요!**

- 각 질환별로 모든 질문을 한 번에 나열하고, 사용자가 그 질환에 대한 답변을 모두 제공할 때까지 대기하세요.
- 질환 순서대로 진행: 질환1 → (답변 완료) → 질환2 → (답변 완료) → 질환3
- 각 질문은 5점 척도로 응답할 수 있도록 제시하세요.
...
**질문 제시 예시**:
```
[질환A]에 대한 질문들입니다. 각 질문에 대해 1~5 중 하나를 선택해주세요:
